...
```{r fig3, fig.height=1, fig.width=2, fig.cap="Figure 2. Prescribing rates in England"}
...
### East of England
```{r fig4, fig.height=1, fig.width=2, fig.cap="Figure 3. Prescribing rates in Regions in England"}
